...
public enum PluginState
{
    ...
    /// <summary>
    /// برای این سیستم‌عامل یا برای این نسخه از لانچر نیست. کامپایل هم نمی‌شود، چون شکستنش قطعی است
    /// و پیام کامپایلر چیزی نیست که کاربر بتواند با آن کاری کند؛ <see cref="PluginDescriptor.Error"/>
    /// دلیل را به زبان آدمیزاد دارد.
    /// </summary>
    Unsupported
}
